...
import org.jetbrains.plugins.template.clazz.GenericClassMemberWrapper;
...
public class PsiCustomUtil {
  ...
  public static List<VirtualFile> findFilesUnderRootInModule(Module module, String targetFileName) {
    VirtualFile[] contentRoots = getInstance(module).getContentRoots();
